...
if (@$_POST['list']=='4')  echo "<meta http-equiv=refresh content='0; url=admin3.php?sel4=selected&count=9&start=0'>";
if (@$_POST['list']=='5')  echo "<meta http-equiv=refresh content='0; url=admin4.php?sel5=selected'>";
if (@$_POST['list']=='6')  echo "<meta http-equiv=refresh content='0; url=admin5.php?sel6=selected'>";
